...
require (
	...
	cloud.google.com/go/spanner v1.76.1 // @grafana/grafana-search-and-storage
	...
	google.golang.org/api v0.226.0 // @grafana/grafana-backend-group
...
require (
	...
	vitess.io/vitess v0.22.0 // indirect
)
