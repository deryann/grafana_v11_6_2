...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/azcore v1.18.2 // @grafana/identity-access-team
	github.com/Azure/azure-sdk-for-go/sdk/azidentity v1.11.0 // @grafana/grafana-backend-group
